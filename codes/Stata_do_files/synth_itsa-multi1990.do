*Stata itsa multi-group after Synth script 1990
...
import delimited ~/sciebo/PhD.BastosdeCastro/ScientificProduction/Paper1/data_package_paper1/output_data_prep/synth_to_itsa1990.csv , clear

*Setting panel time series data for  multiple group analysis 
tsset code year

*Running itsa after Synth pre-processing
itsa value , treat(1) contid(2) trperiod(1990) lag(0)posttrend replace figure
